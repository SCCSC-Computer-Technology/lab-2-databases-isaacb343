...
namespace I_Billow_Lab2.CityDBDataSetTableAdapters {
...
SELECT CityID, City, State, Population FROM City WHERE (CityID = @CityID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::I_Billow_Lab2.Properties.Settings.Default.CityDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[City] WHERE CityID = @ID;";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CityID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
